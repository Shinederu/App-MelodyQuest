import { HttpService } from "../utils/HttpService.js?v=20260617-category-default-visible";
import { HeaderModel } from "../model/HeaderModel.js?v=20260617-category-default-visible";
import { WakeLockService } from "../utils/WakeLockService.js?v=20260617-category-default-visible";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260617-category-default-visible";
import { PublicController } from "./PublicController.js?v=20260617-category-default-visible";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260617-category-default-visible";
import { MainController } from "./MainController.js?v=20260617-category-default-visible";
import { AutoplaySetupController } from "./AutoplaySetupController.js?v=20260617-category-default-visible";
import { AutoplayController } from "./AutoplayController.js?v=20260617-category-default-visible";
import { LobbyController } from "./LobbyController.js?v=20260617-category-default-visible";
import { LobbyListController } from "./LobbyListController.js?v=20260617-category-default-visible";
import { GameController } from "./GameController.js?v=20260617-category-default-visible";
import { ResultController } from "./ResultController.js?v=20260617-category-default-visible";
import { TvController } from "./TvController.js?v=20260617-category-default-visible";
import { TvLinkController } from "./TvLinkController.js?v=20260617-category-default-visible";
import { ManagementController } from "./ManagementController.js?v=20260617-category-default-visible";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260617-category-default-visible";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260617-category-default-visible";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260617-category-default-visible";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260617-category-default-visible";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260617-category-default-visible";

const ASSET_VERSION = "20260617-category-default-visible";
