import { HttpService } from "../utils/HttpService.js?v=20260616-game-layout-scroll-fix";
import { HeaderModel } from "../model/HeaderModel.js?v=20260616-game-layout-scroll-fix";
import { WakeLockService } from "../utils/WakeLockService.js?v=20260616-game-layout-scroll-fix";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260616-game-layout-scroll-fix";
import { PublicController } from "./PublicController.js?v=20260616-game-layout-scroll-fix";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260616-game-layout-scroll-fix";
import { MainController } from "./MainController.js?v=20260616-game-layout-scroll-fix";
import { LobbyController } from "./LobbyController.js?v=20260616-game-layout-scroll-fix";
import { LobbyListController } from "./LobbyListController.js?v=20260616-game-layout-scroll-fix";
import { GameController } from "./GameController.js?v=20260616-game-layout-scroll-fix";
import { ResultController } from "./ResultController.js?v=20260616-game-layout-scroll-fix";
import { TvController } from "./TvController.js?v=20260616-game-layout-scroll-fix";
import { TvLinkController } from "./TvLinkController.js?v=20260616-game-layout-scroll-fix";
import { ManagementController } from "./ManagementController.js?v=20260616-game-layout-scroll-fix";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260616-game-layout-scroll-fix";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260616-game-layout-scroll-fix";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260616-game-layout-scroll-fix";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260616-game-layout-scroll-fix";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260616-game-layout-scroll-fix";

const ASSET_VERSION = "20260616-game-layout-scroll-fix";
