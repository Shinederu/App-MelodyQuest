import { HttpService } from "../utils/HttpService.js?v=20260616-answer-history";
import { HeaderModel } from "../model/HeaderModel.js?v=20260616-answer-history";
import { WakeLockService } from "../utils/WakeLockService.js?v=20260616-answer-history";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260616-answer-history";
import { PublicController } from "./PublicController.js?v=20260616-answer-history";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260616-answer-history";
import { MainController } from "./MainController.js?v=20260616-answer-history";
import { LobbyController } from "./LobbyController.js?v=20260616-answer-history";
import { LobbyListController } from "./LobbyListController.js?v=20260616-answer-history";
import { GameController } from "./GameController.js?v=20260616-answer-history";
import { ResultController } from "./ResultController.js?v=20260616-answer-history";
import { TvController } from "./TvController.js?v=20260616-answer-history";
import { TvLinkController } from "./TvLinkController.js?v=20260616-answer-history";
import { ManagementController } from "./ManagementController.js?v=20260616-answer-history";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260616-answer-history";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260616-answer-history";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260616-answer-history";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260616-answer-history";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260616-answer-history";

const ASSET_VERSION = "20260616-answer-history";
