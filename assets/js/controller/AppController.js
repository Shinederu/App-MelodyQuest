import { HttpService } from "../utils/HttpService.js?v=20260616-answer-default-80";
import { HeaderModel } from "../model/HeaderModel.js?v=20260616-answer-default-80";
import { WakeLockService } from "../utils/WakeLockService.js?v=20260616-answer-default-80";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260616-answer-default-80";
import { PublicController } from "./PublicController.js?v=20260616-answer-default-80";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260616-answer-default-80";
import { MainController } from "./MainController.js?v=20260616-answer-default-80";
import { LobbyController } from "./LobbyController.js?v=20260616-answer-default-80";
import { LobbyListController } from "./LobbyListController.js?v=20260616-answer-default-80";
import { GameController } from "./GameController.js?v=20260616-answer-default-80";
import { ResultController } from "./ResultController.js?v=20260616-answer-default-80";
import { TvController } from "./TvController.js?v=20260616-answer-default-80";
import { TvLinkController } from "./TvLinkController.js?v=20260616-answer-default-80";
import { ManagementController } from "./ManagementController.js?v=20260616-answer-default-80";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260616-answer-default-80";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260616-answer-default-80";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260616-answer-default-80";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260616-answer-default-80";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260616-answer-default-80";

const ASSET_VERSION = "20260616-answer-default-80";
