import { HttpService } from "../utils/HttpService.js?v=20260617-autoplay-estimate";
import { HeaderModel } from "../model/HeaderModel.js?v=20260617-autoplay-estimate";
import { WakeLockService } from "../utils/WakeLockService.js?v=20260617-autoplay-estimate";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260617-autoplay-estimate";
import { PublicController } from "./PublicController.js?v=20260617-autoplay-estimate";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260617-autoplay-estimate";
import { MainController } from "./MainController.js?v=20260617-autoplay-estimate";
import { AutoplaySetupController } from "./AutoplaySetupController.js?v=20260617-autoplay-estimate";
import { AutoplayController } from "./AutoplayController.js?v=20260617-autoplay-estimate";
import { LobbyController } from "./LobbyController.js?v=20260617-autoplay-estimate";
import { LobbyListController } from "./LobbyListController.js?v=20260617-autoplay-estimate";
import { GameController } from "./GameController.js?v=20260617-autoplay-estimate";
import { ResultController } from "./ResultController.js?v=20260617-autoplay-estimate";
import { TvController } from "./TvController.js?v=20260617-autoplay-estimate";
import { TvLinkController } from "./TvLinkController.js?v=20260617-autoplay-estimate";
import { ManagementController } from "./ManagementController.js?v=20260617-autoplay-estimate";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260617-autoplay-estimate";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260617-autoplay-estimate";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260617-autoplay-estimate";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260617-autoplay-estimate";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260617-autoplay-estimate";

const ASSET_VERSION = "20260617-autoplay-estimate";
