import { HttpService } from "../utils/HttpService.js?v=20260617-passive-tv-cleanup";
import { HeaderModel } from "../model/HeaderModel.js?v=20260617-passive-tv-cleanup";
import { WakeLockService } from "../utils/WakeLockService.js?v=20260617-passive-tv-cleanup";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260617-passive-tv-cleanup";
import { PublicController } from "./PublicController.js?v=20260617-passive-tv-cleanup";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260617-passive-tv-cleanup";
import { MainController } from "./MainController.js?v=20260617-passive-tv-cleanup";
import { AutoplaySetupController } from "./AutoplaySetupController.js?v=20260617-passive-tv-cleanup";
import { AutoplayController } from "./AutoplayController.js?v=20260617-passive-tv-cleanup";
import { LobbyController } from "./LobbyController.js?v=20260617-passive-tv-cleanup";
import { LobbyListController } from "./LobbyListController.js?v=20260617-passive-tv-cleanup";
import { GameController } from "./GameController.js?v=20260617-passive-tv-cleanup";
import { ResultController } from "./ResultController.js?v=20260617-passive-tv-cleanup";
import { TvController } from "./TvController.js?v=20260617-passive-tv-cleanup";
import { TvLinkController } from "./TvLinkController.js?v=20260617-passive-tv-cleanup";
import { ManagementController } from "./ManagementController.js?v=20260617-passive-tv-cleanup";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260617-passive-tv-cleanup";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260617-passive-tv-cleanup";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260617-passive-tv-cleanup";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260617-passive-tv-cleanup";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260617-passive-tv-cleanup";

const ASSET_VERSION = "20260617-passive-tv-cleanup";
