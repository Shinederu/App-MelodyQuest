import { HttpService } from "../utils/HttpService.js?v=20260616-game-header-tools-fit";
import { HeaderModel } from "../model/HeaderModel.js?v=20260616-game-header-tools-fit";
import { WakeLockService } from "../utils/WakeLockService.js?v=20260616-game-header-tools-fit";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260616-game-header-tools-fit";
import { PublicController } from "./PublicController.js?v=20260616-game-header-tools-fit";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260616-game-header-tools-fit";
import { MainController } from "./MainController.js?v=20260616-game-header-tools-fit";
import { LobbyController } from "./LobbyController.js?v=20260616-game-header-tools-fit";
import { LobbyListController } from "./LobbyListController.js?v=20260616-game-header-tools-fit";
import { GameController } from "./GameController.js?v=20260616-game-header-tools-fit";
import { ResultController } from "./ResultController.js?v=20260616-game-header-tools-fit";
import { TvController } from "./TvController.js?v=20260616-game-header-tools-fit";
import { TvLinkController } from "./TvLinkController.js?v=20260616-game-header-tools-fit";
import { ManagementController } from "./ManagementController.js?v=20260616-game-header-tools-fit";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260616-game-header-tools-fit";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260616-game-header-tools-fit";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260616-game-header-tools-fit";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260616-game-header-tools-fit";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260616-game-header-tools-fit";

const ASSET_VERSION = "20260616-game-header-tools-fit";
