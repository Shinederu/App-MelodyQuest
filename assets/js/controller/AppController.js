import { HttpService } from "../utils/HttpService.js?v=20260615-ui-flow";
import { HeaderModel } from "../model/HeaderModel.js?v=20260615-ui-flow";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260615-ui-flow";
import { PublicController } from "./PublicController.js?v=20260615-ui-flow";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260615-ui-flow";
import { MainController } from "./MainController.js?v=20260615-ui-flow";
import { LobbyController } from "./LobbyController.js?v=20260615-ui-flow";
import { LobbyListController } from "./LobbyListController.js?v=20260615-ui-flow";
import { GameController } from "./GameController.js?v=20260615-ui-flow";
import { ResultController } from "./ResultController.js?v=20260615-ui-flow";
import { TvController } from "./TvController.js?v=20260615-ui-flow";
import { TvLinkController } from "./TvLinkController.js?v=20260615-ui-flow";
import { ManagementController } from "./ManagementController.js?v=20260615-ui-flow";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260615-ui-flow";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260615-ui-flow";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260615-ui-flow";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260615-ui-flow";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260615-ui-flow";

const ASSET_VERSION = "20260615-ui-flow";
