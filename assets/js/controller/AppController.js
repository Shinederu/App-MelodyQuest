import { HttpService } from "../utils/HttpService.js?v=20260616-player-menu-cleanup";
import { HeaderModel } from "../model/HeaderModel.js?v=20260616-player-menu-cleanup";
import { WakeLockService } from "../utils/WakeLockService.js?v=20260616-player-menu-cleanup";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260616-player-menu-cleanup";
import { PublicController } from "./PublicController.js?v=20260616-player-menu-cleanup";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260616-player-menu-cleanup";
import { MainController } from "./MainController.js?v=20260616-player-menu-cleanup";
import { LobbyController } from "./LobbyController.js?v=20260616-player-menu-cleanup";
import { LobbyListController } from "./LobbyListController.js?v=20260616-player-menu-cleanup";
import { GameController } from "./GameController.js?v=20260616-player-menu-cleanup";
import { ResultController } from "./ResultController.js?v=20260616-player-menu-cleanup";
import { TvController } from "./TvController.js?v=20260616-player-menu-cleanup";
import { TvLinkController } from "./TvLinkController.js?v=20260616-player-menu-cleanup";
import { ManagementController } from "./ManagementController.js?v=20260616-player-menu-cleanup";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260616-player-menu-cleanup";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260616-player-menu-cleanup";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260616-player-menu-cleanup";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260616-player-menu-cleanup";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260616-player-menu-cleanup";

const ASSET_VERSION = "20260616-player-menu-cleanup";
