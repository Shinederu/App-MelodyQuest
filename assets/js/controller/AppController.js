import { HttpService } from "../utils/HttpService.js?v=20260617-game-action-compact";
import { HeaderModel } from "../model/HeaderModel.js?v=20260617-game-action-compact";
import { WakeLockService } from "../utils/WakeLockService.js?v=20260617-game-action-compact";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260617-game-action-compact";
import { PublicController } from "./PublicController.js?v=20260617-game-action-compact";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260617-game-action-compact";
import { MainController } from "./MainController.js?v=20260617-game-action-compact";
import { LobbyController } from "./LobbyController.js?v=20260617-game-action-compact";
import { LobbyListController } from "./LobbyListController.js?v=20260617-game-action-compact";
import { GameController } from "./GameController.js?v=20260617-game-action-compact";
import { ResultController } from "./ResultController.js?v=20260617-game-action-compact";
import { TvController } from "./TvController.js?v=20260617-game-action-compact";
import { TvLinkController } from "./TvLinkController.js?v=20260617-game-action-compact";
import { ManagementController } from "./ManagementController.js?v=20260617-game-action-compact";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260617-game-action-compact";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260617-game-action-compact";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260617-game-action-compact";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260617-game-action-compact";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260617-game-action-compact";

const ASSET_VERSION = "20260617-game-action-compact";
