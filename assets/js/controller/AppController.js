import { HttpService } from "../utils/HttpService.js?v=20260617-game-toolbar-cleanup";
import { HeaderModel } from "../model/HeaderModel.js?v=20260617-game-toolbar-cleanup";
import { WakeLockService } from "../utils/WakeLockService.js?v=20260617-game-toolbar-cleanup";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260617-game-toolbar-cleanup";
import { PublicController } from "./PublicController.js?v=20260617-game-toolbar-cleanup";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260617-game-toolbar-cleanup";
import { MainController } from "./MainController.js?v=20260617-game-toolbar-cleanup";
import { AutoplaySetupController } from "./AutoplaySetupController.js?v=20260617-game-toolbar-cleanup";
import { AutoplayController } from "./AutoplayController.js?v=20260617-game-toolbar-cleanup";
import { LobbyController } from "./LobbyController.js?v=20260617-game-toolbar-cleanup";
import { LobbyListController } from "./LobbyListController.js?v=20260617-game-toolbar-cleanup";
import { GameController } from "./GameController.js?v=20260617-game-toolbar-cleanup";
import { ResultController } from "./ResultController.js?v=20260617-game-toolbar-cleanup";
import { TvController } from "./TvController.js?v=20260617-game-toolbar-cleanup";
import { TvLinkController } from "./TvLinkController.js?v=20260617-game-toolbar-cleanup";
import { ManagementController } from "./ManagementController.js?v=20260617-game-toolbar-cleanup";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260617-game-toolbar-cleanup";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260617-game-toolbar-cleanup";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260617-game-toolbar-cleanup";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260617-game-toolbar-cleanup";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260617-game-toolbar-cleanup";

const ASSET_VERSION = "20260617-game-toolbar-cleanup";
