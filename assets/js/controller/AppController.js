import { HttpService } from "../utils/HttpService.js?v=20260616-game-flow-fixes";
import { HeaderModel } from "../model/HeaderModel.js?v=20260616-game-flow-fixes";
import { WakeLockService } from "../utils/WakeLockService.js?v=20260616-game-flow-fixes";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260616-game-flow-fixes";
import { PublicController } from "./PublicController.js?v=20260616-game-flow-fixes";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260616-game-flow-fixes";
import { MainController } from "./MainController.js?v=20260616-game-flow-fixes";
import { LobbyController } from "./LobbyController.js?v=20260616-game-flow-fixes";
import { LobbyListController } from "./LobbyListController.js?v=20260616-game-flow-fixes";
import { GameController } from "./GameController.js?v=20260616-game-flow-fixes";
import { ResultController } from "./ResultController.js?v=20260616-game-flow-fixes";
import { TvController } from "./TvController.js?v=20260616-game-flow-fixes";
import { TvLinkController } from "./TvLinkController.js?v=20260616-game-flow-fixes";
import { ManagementController } from "./ManagementController.js?v=20260616-game-flow-fixes";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260616-game-flow-fixes";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260616-game-flow-fixes";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260616-game-flow-fixes";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260616-game-flow-fixes";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260616-game-flow-fixes";

const ASSET_VERSION = "20260616-game-flow-fixes";
