import { HttpService } from "../utils/HttpService.js?v=20260619-autoplay-return-lobby";
import { HeaderModel } from "../model/HeaderModel.js?v=20260619-autoplay-return-lobby";
import { WakeLockService } from "../utils/WakeLockService.js?v=20260619-autoplay-return-lobby";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260619-autoplay-return-lobby";
import { PublicController } from "./PublicController.js?v=20260619-autoplay-return-lobby";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260619-autoplay-return-lobby";
import { MainController } from "./MainController.js?v=20260619-autoplay-return-lobby";
import { AutoplaySetupController } from "./AutoplaySetupController.js?v=20260619-autoplay-return-lobby";
import { AutoplayController } from "./AutoplayController.js?v=20260619-autoplay-return-lobby";
import { LobbyController } from "./LobbyController.js?v=20260619-autoplay-return-lobby";
import { LobbyListController } from "./LobbyListController.js?v=20260619-autoplay-return-lobby";
import { GameController } from "./GameController.js?v=20260619-autoplay-return-lobby";
import { ResultController } from "./ResultController.js?v=20260619-autoplay-return-lobby";
import { TvController } from "./TvController.js?v=20260619-autoplay-return-lobby";
import { TvLinkController } from "./TvLinkController.js?v=20260619-autoplay-return-lobby";
import { ManagementController } from "./ManagementController.js?v=20260619-autoplay-return-lobby";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260619-autoplay-return-lobby";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260619-autoplay-return-lobby";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260619-autoplay-return-lobby";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260619-autoplay-return-lobby";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260619-autoplay-return-lobby";
import { ManagementAnswersController } from "./ManagementAnswersController.js?v=20260619-autoplay-return-lobby";

const ASSET_VERSION = "20260619-autoplay-return-lobby";
