import { HttpService } from "../utils/HttpService.js?v=20260616-game-action-layout";
import { HeaderModel } from "../model/HeaderModel.js?v=20260616-game-action-layout";
import { WakeLockService } from "../utils/WakeLockService.js?v=20260616-game-action-layout";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260616-game-action-layout";
import { PublicController } from "./PublicController.js?v=20260616-game-action-layout";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260616-game-action-layout";
import { MainController } from "./MainController.js?v=20260616-game-action-layout";
import { LobbyController } from "./LobbyController.js?v=20260616-game-action-layout";
import { LobbyListController } from "./LobbyListController.js?v=20260616-game-action-layout";
import { GameController } from "./GameController.js?v=20260616-game-action-layout";
import { ResultController } from "./ResultController.js?v=20260616-game-action-layout";
import { TvController } from "./TvController.js?v=20260616-game-action-layout";
import { TvLinkController } from "./TvLinkController.js?v=20260616-game-action-layout";
import { ManagementController } from "./ManagementController.js?v=20260616-game-action-layout";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260616-game-action-layout";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260616-game-action-layout";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260616-game-action-layout";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260616-game-action-layout";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260616-game-action-layout";

const ASSET_VERSION = "20260616-game-action-layout";
