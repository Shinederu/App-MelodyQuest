import { HttpService } from "../utils/HttpService.js?v=20260616-answer-visibility";
import { HeaderModel } from "../model/HeaderModel.js?v=20260616-answer-visibility";
import { WakeLockService } from "../utils/WakeLockService.js?v=20260616-answer-visibility";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260616-answer-visibility";
import { PublicController } from "./PublicController.js?v=20260616-answer-visibility";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260616-answer-visibility";
import { MainController } from "./MainController.js?v=20260616-answer-visibility";
import { LobbyController } from "./LobbyController.js?v=20260616-answer-visibility";
import { LobbyListController } from "./LobbyListController.js?v=20260616-answer-visibility";
import { GameController } from "./GameController.js?v=20260616-answer-visibility";
import { ResultController } from "./ResultController.js?v=20260616-answer-visibility";
import { TvController } from "./TvController.js?v=20260616-answer-visibility";
import { TvLinkController } from "./TvLinkController.js?v=20260616-answer-visibility";
import { ManagementController } from "./ManagementController.js?v=20260616-answer-visibility";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260616-answer-visibility";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260616-answer-visibility";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260616-answer-visibility";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260616-answer-visibility";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260616-answer-visibility";

const ASSET_VERSION = "20260616-answer-visibility";
