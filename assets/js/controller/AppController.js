import { HttpService } from "../utils/HttpService.js?v=20260717-compact-landscape";
import { HeaderModel } from "../model/HeaderModel.js?v=20260717-compact-landscape";
import { WakeLockService } from "../utils/WakeLockService.js?v=20260717-compact-landscape";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260717-compact-landscape";
import { PublicController } from "./PublicController.js?v=20260717-compact-landscape";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260717-compact-landscape";
import { MainController } from "./MainController.js?v=20260717-compact-landscape";
import { AutoplaySetupController } from "./AutoplaySetupController.js?v=20260717-compact-landscape";
import { AutoplayController } from "./AutoplayController.js?v=20260717-compact-landscape";
import { LobbyController } from "./LobbyController.js?v=20260717-compact-landscape";
import { LobbyListController } from "./LobbyListController.js?v=20260717-compact-landscape";
import { GameController } from "./GameController.js?v=20260717-compact-landscape";
import { ResultController } from "./ResultController.js?v=20260717-compact-landscape";
import { TvController } from "./TvController.js?v=20260717-compact-landscape";
import { TvLinkController } from "./TvLinkController.js?v=20260717-compact-landscape";
import { ManagementController } from "./ManagementController.js?v=20260717-compact-landscape";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260717-compact-landscape";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260717-compact-landscape";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260717-compact-landscape";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260717-compact-landscape";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260717-compact-landscape";
import { ManagementAnswersController } from "./ManagementAnswersController.js?v=20260717-compact-landscape";

const ASSET_VERSION = "20260717-compact-landscape";
