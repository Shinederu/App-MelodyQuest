import { HttpService } from "../utils/HttpService.js?v=20260616-owner-presence";
import { HeaderModel } from "../model/HeaderModel.js?v=20260616-owner-presence";
import { WakeLockService } from "../utils/WakeLockService.js?v=20260616-owner-presence";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260616-owner-presence";
import { PublicController } from "./PublicController.js?v=20260616-owner-presence";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260616-owner-presence";
import { MainController } from "./MainController.js?v=20260616-owner-presence";
import { LobbyController } from "./LobbyController.js?v=20260616-owner-presence";
import { LobbyListController } from "./LobbyListController.js?v=20260616-owner-presence";
import { GameController } from "./GameController.js?v=20260616-owner-presence";
import { ResultController } from "./ResultController.js?v=20260616-owner-presence";
import { TvController } from "./TvController.js?v=20260616-owner-presence";
import { TvLinkController } from "./TvLinkController.js?v=20260616-owner-presence";
import { ManagementController } from "./ManagementController.js?v=20260616-owner-presence";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260616-owner-presence";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260616-owner-presence";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260616-owner-presence";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260616-owner-presence";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260616-owner-presence";

const ASSET_VERSION = "20260616-owner-presence";
