import { HttpService } from "../utils/HttpService.js?v=20260615-playtest-improvements";
import { HeaderModel } from "../model/HeaderModel.js?v=20260615-playtest-improvements";
import { WakeLockService } from "../utils/WakeLockService.js?v=20260615-playtest-improvements";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260615-playtest-improvements";
import { PublicController } from "./PublicController.js?v=20260615-playtest-improvements";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260615-playtest-improvements";
import { MainController } from "./MainController.js?v=20260615-playtest-improvements";
import { LobbyController } from "./LobbyController.js?v=20260615-playtest-improvements";
import { LobbyListController } from "./LobbyListController.js?v=20260615-playtest-improvements";
import { GameController } from "./GameController.js?v=20260615-playtest-improvements";
import { ResultController } from "./ResultController.js?v=20260615-playtest-improvements";
import { TvController } from "./TvController.js?v=20260615-playtest-improvements";
import { TvLinkController } from "./TvLinkController.js?v=20260615-playtest-improvements";
import { ManagementController } from "./ManagementController.js?v=20260615-playtest-improvements";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260615-playtest-improvements";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260615-playtest-improvements";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260615-playtest-improvements";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260615-playtest-improvements";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260615-playtest-improvements";

const ASSET_VERSION = "20260615-playtest-improvements";
