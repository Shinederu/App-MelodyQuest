import { HttpService } from "../utils/HttpService.js?v=20260617-lobby-mode-switch";
import { HeaderModel } from "../model/HeaderModel.js?v=20260617-lobby-mode-switch";
import { WakeLockService } from "../utils/WakeLockService.js?v=20260617-lobby-mode-switch";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260617-lobby-mode-switch";
import { PublicController } from "./PublicController.js?v=20260617-lobby-mode-switch";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260617-lobby-mode-switch";
import { MainController } from "./MainController.js?v=20260617-lobby-mode-switch";
import { AutoplaySetupController } from "./AutoplaySetupController.js?v=20260617-lobby-mode-switch";
import { AutoplayController } from "./AutoplayController.js?v=20260617-lobby-mode-switch";
import { LobbyController } from "./LobbyController.js?v=20260617-lobby-mode-switch";
import { LobbyListController } from "./LobbyListController.js?v=20260617-lobby-mode-switch";
import { GameController } from "./GameController.js?v=20260617-lobby-mode-switch";
import { ResultController } from "./ResultController.js?v=20260617-lobby-mode-switch";
import { TvController } from "./TvController.js?v=20260617-lobby-mode-switch";
import { TvLinkController } from "./TvLinkController.js?v=20260617-lobby-mode-switch";
import { ManagementController } from "./ManagementController.js?v=20260617-lobby-mode-switch";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260617-lobby-mode-switch";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260617-lobby-mode-switch";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260617-lobby-mode-switch";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260617-lobby-mode-switch";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260617-lobby-mode-switch";

const ASSET_VERSION = "20260617-lobby-mode-switch";
