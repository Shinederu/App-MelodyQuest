import { HttpService } from "../utils/HttpService.js?v=20260617-lobby-mode-review";
import { HeaderModel } from "../model/HeaderModel.js?v=20260617-lobby-mode-review";
import { WakeLockService } from "../utils/WakeLockService.js?v=20260617-lobby-mode-review";
import { loadYouTubeIframeApi } from "../utils/youtube.js?v=20260617-lobby-mode-review";
import { PublicController } from "./PublicController.js?v=20260617-lobby-mode-review";
import { SuggestTrackController } from "./SuggestTrackController.js?v=20260617-lobby-mode-review";
import { MainController } from "./MainController.js?v=20260617-lobby-mode-review";
import { AutoplaySetupController } from "./AutoplaySetupController.js?v=20260617-lobby-mode-review";
import { AutoplayController } from "./AutoplayController.js?v=20260617-lobby-mode-review";
import { LobbyController } from "./LobbyController.js?v=20260617-lobby-mode-review";
import { LobbyListController } from "./LobbyListController.js?v=20260617-lobby-mode-review";
import { GameController } from "./GameController.js?v=20260617-lobby-mode-review";
import { ResultController } from "./ResultController.js?v=20260617-lobby-mode-review";
import { TvController } from "./TvController.js?v=20260617-lobby-mode-review";
import { TvLinkController } from "./TvLinkController.js?v=20260617-lobby-mode-review";
import { ManagementController } from "./ManagementController.js?v=20260617-lobby-mode-review";
import { ManagementCategoriesController } from "./ManagementCategoriesController.js?v=20260617-lobby-mode-review";
import { ManagementFamiliesController } from "./ManagementFamiliesController.js?v=20260617-lobby-mode-review";
import { ManagementTracksController } from "./ManagementTracksController.js?v=20260617-lobby-mode-review";
import { ManagementValidationController } from "./ManagementValidationController.js?v=20260617-lobby-mode-review";
import { ManagementSuggestionsController } from "./ManagementSuggestionsController.js?v=20260617-lobby-mode-review";

const ASSET_VERSION = "20260617-lobby-mode-review";
