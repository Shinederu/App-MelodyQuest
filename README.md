...
- cache-bust JS courant: `20260616-owner-presence`;
- cache-bust CSS courant: `20260616-owner-presence`;
...
- smoke test `/tv`: QR affiche, script `20260616-owner-presence`, CSS `20260616-owner-presence`, aucun conteneur `tv-video-preload-player`, aucune erreur console.
...
- Presence joueur manuelle avec mode absent: les joueurs absents restent visibles, mais ne bloquent plus les votes et transitions. Fermer l'onglet ne change pas automatiquement le statut; le createur peut passer un joueur absent/present ou exclure un joueur qui ne revient pas.
...
- Historique d'essais de reponse affiche selon le niveau de revelation autorise par l'API.
