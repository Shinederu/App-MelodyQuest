...
- cache-bust JS courant: `20260616-answer-default-80`;
- cache-bust CSS courant: `20260616-answer-default-80`;
...
- smoke test `/tv`: QR affiche, script `20260616-answer-default-80`, CSS `20260616-answer-default-80`, aucun conteneur `tv-video-preload-player`, aucune erreur console.
