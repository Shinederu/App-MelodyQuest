...
- cache-bust JS courant: `20260617-lobby-mode-switch`;
- cache-bust CSS courant: `20260617-lobby-mode-switch`;
...
- `#/autoplay-setup`: ancien ecran direct de configuration d'un blindtest automatique sans score; le flux principal passe maintenant par `#/main` puis `#/lobby` en mode passif.
