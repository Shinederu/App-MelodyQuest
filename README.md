...
- cache-bust JS courant: `20260617-autoplay-estimate`;
- cache-bust CSS courant: `20260617-autoplay-estimate`;
...
- `#/autoplay-setup`: configuration d'un blindtest automatique sans score.
